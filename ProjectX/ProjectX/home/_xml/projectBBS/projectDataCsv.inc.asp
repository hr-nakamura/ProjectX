...
var mode = "-1"
var modeTab = {"0":"0","1":"1","4":"4","5":"5","-1":"-1"}
...
var infoTab = {
   ...
   SQL += "    newDate      = CONVERT(CHAR(10),projectNum.newDate,111) + ' ' + CONVERT(CHAR(8),projectNum.newDate,14),"
   SQL += "    makeDate     = CONVERT(CHAR(10),projectNum.makeDate,111) + ' ' + CONVERT(CHAR(8),projectNum.makeDate,14),"
   SQL += "    editDate     = CONVERT(CHAR(10),projectNum.editDate,111) + ' ' + CONVERT(CHAR(8),projectNum.editDate,14),"
...
//   SQL += "    (projectNum.pNum >= " + limitNum + ")"
//   if( IsObject(modeTab[mode])){		 // 0,1,4,5,-1"
//   SQL += "    AND"
//   SQL += "    projectNum.stat = -1"
//   }
   SQL += " ORDER BY"
...
/*
   ...
   Head[i++] = "規模:String"
   Head[i++] = "場所:String"
   Head[i++] = "newDate:String"
   Head[i++] = "makeDate:String"
   Head[i++] = "editDate:String"
*/
