...
mainTitle.innerHTML = String(year + "年度　売上実績+予測（分類別）").big()
...
<SCRIPT FOR="onDispX" EVENT="onclick" LANGUAGE="JavaScript">
//alert("更新中です、しばらくお待ちください" + "][" + this.gName)
winOpen(this.gName,this.yymm,this.dispCnt,this.actualCnt)
</SCRIPT>
<SCRIPT FOR="onDispX" EVENT="onmouseover" LANGUAGE="JavaScript">
this.style.cursor = "hand"
//this.style.color="red"
</SCRIPT>
<SCRIPT FOR="onDispX" EVENT="onmouseout" LANGUAGE="JavaScript">
this.style.cursor = ""
